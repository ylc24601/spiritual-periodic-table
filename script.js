const elements = [
  ...
  {sym:'O',no:8,zh:'氧',eng:'Oxygen',type:'action',
   ...
   verse:'趁著白日，我們必須做那差我來者的工。\n—約 9:4',person:'巴拿巴',personNote:'扶持保羅的使徒，以鼓勵人聞名'},
  ...
  {sym:'Ti',no:22,zh:'鈦',eng:'Titanium',type:'action',
   title:'跨界先鋒的<br>改革者',target:'職場基督徒、跨界服事的社青',
  ...
  {sym:'Au',no:79,zh:'金',eng:'Gold',type:'structural',
   title:'歷久彌新的<br>智慧者',target:'經歷過風浪的長輩',
   sci:'抗腐蝕、延展性佳、不怕火煉',
   sp:'經歷風浪信心依然堅定；話語寶貴能給年輕人指引；心胸寬大具包容性。',
   weak:'穩健是你的智慧；學習在適當時機說出現在就去做，是你給年輕一代的禮物。',
   verse:'祂試煉我之後，我必如精金。\n—伯 23:10',person:'約伯'},
  {sym:'Fe',no:26,zh:'鐵',eng:'Iron',type:'structural',
   ...
   verse:'我也專心修造這城牆，並沒有置買田地。\n—尼 5:16',person:'尼希米',personNote:'帶領重建耶路撒冷城牆的領袖'},
  ...
  {sym:'Cu',no:29,zh:'銅',eng:'Copper',type:'relational',
   title:'溫暖傳遞的<br>協調者',target:'熱心助人者或閱歷豐富的長輩',
   sci:'導電導熱佳、會生成銅綠保護層',
   sp:'熱心傳遞愛的溫暖；善於溝通協調；歲月痕跡是智慧的保護層。',
   weak:'協調是你的溫度；學習讓對方自己走出那一步，是愛的成熟。',
   verse:'要用愛心說誠實話。\n—弗 4:15',person:'百基拉',personNote:'與丈夫亞居拉同工的女傳道人'},
  ...
  {sym:'K',no:19,zh:'鉀',eng:'Potassium',type:'relational',
   ...
   verse:'我晝夜不住地為你禱告。\n—提後 1:3',person:'哈拿',personNote:'禱告等候的母親，撒母耳之母'},
  ...
  {sym:'Ag',no:47,zh:'銀',eng:'Silver',type:'stabilizing',
   title:'反映基督的<br>聖潔者',target:'在意言行、經常自省的人',
...
const compounds = [
  {f:'NaCl',pun:'氯接鈉 ＝ 接納',desc:'最衝動的鈉（Na）＋最剛直的氯（Cl），鍵結後成為食鹽——生命必需、溫和穩定。教會裡最難合作的兩種人，彼此接納之後，反而成為世上的鹽。',verse:'你們是世上的鹽。—太 5:13'},
  {f:'H₂O',pun:'氫＋氧 ＝ 活水',desc:'最輕最簡單的氫（H）＋助燃的氧（O），合而為一不是爆炸，而是活水。謙卑單純的人與熱情激勵者同心，湧現生命泉源。',verse:'我所賜的水，在他裡頭成為泉源，直湧到永生。—約 4:14'},
  {f:'CO₂',pun:'碳＋氧 ＝ 呼出的禱告',desc:'看似廢棄的碳與氧組合，卻是植物光合作用的養分，使萬物生長。你覺得軟弱的禱告，在神手中成為滋養他人的力量。',verse:'聖靈親自用說不出來的嘆息替我們禱告。—羅 8:26'},
  {f:'CaC₂',pun:'電石 ＝ 等候發光',desc:'鈣（Ca）與碳（C）平時沉默，看似無用，遇到活水卻立刻燃燒發光。許多幕後同工就像電石——他們在等候聖靈澆灌的時刻。',verse:'耶穌又對眾人說：我是世界的光。跟從我的，就不在黑暗裡走，必要得著生命的光。—約 8:12'},
  {f:'AgCl',pun:'感光底片 ＝ 屬靈攝影師',desc:'聖潔的銀（Ag）＋守望的氯（Cl）→ 氯化銀是傳統底片感光材料，對光極度敏感。他們記錄神在群體中的作為，是教會的見證者。',verse:'所以你要把所看見的，和現在的事，並將來必成的事，都寫出來。—啟 1:19'},
  {f:'AuCu',pun:'玫瑰合金 ＝ 成熟的接納',desc:'亮金的尊貴與銅的溫暖交織成玫瑰金——成熟與親切一起，讓服事既高貴又貼近人心。',verse:'愛是恆久忍耐，又有恩慈。—林前 13:4'},
  {f:'SiO₂',pun:'矽氧共舞 ＝ 智慧透明',desc:'矽（Si）是堅固基礎，氧（O）是生命氣息；合而為一成為透明的玻璃。清晰而穩固的團隊，來自理性與熱情的共同築造。',verse:'智慧比珍珠更寶貴。—箴 3:15'},
  {f:'SiC',pun:'碳化矽 ＝ 磨礪相長',desc:'理性穩重的矽（Si）＋靈活適應的碳（C），合成碳化矽——硬度僅次於鑽石，是最鋒利的磨具。教會裡最互補的搭檔，不是讓彼此舒服，而是讓彼此更銳利。',verse:'鐵磨鐵，磨出刃來；朋友相感，也是如此。—箴 27:17'},
  {f:'TiO₂',pun:'鈦陽 ＝ 在光中潔淨',desc:'最強韌的鈦（Ti）＋助燃的氧（O），合成二氧化鈦——光觸媒，在陽光照射下能分解一切污垢。改革者與激勵者結合，在光裡帶來更新與潔淨。',verse:'你們是世上的光。—太 5:14'},
  {f:'KCl',pun:'守護心跳的鹽',desc:'感知心律的鉀（K）＋殺菌守望的氯（Cl），合成氯化鉀——補充心律失調缺乏的電解質。敏銳的禱告者與剛直的守望者結合，是教會靈命的護心鹽。',verse:'我立你作以色列家守望的人。—結 3:17'}
];
